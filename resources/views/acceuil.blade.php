        ...
        <div class="container-fluid nav-bar bg-transparent">
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-0 px-4">
                <a href="index.html" class="navbar-brand d-flex align-items-center text-center">
                    ...
                    <h1 class="m-0 text-primary">ala Immobilier</h1>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu rounded-0 m-0">
                                <a href="testimonial.html" class="dropdown-item active">disponible</a>
                                <a href="404.html" class="dropdown-item">occupe</a>
                            </div>
                        </div>
                        <a href="/connexion" class="nav-item nav-link">se connecter</a>
                    </div>
                    <a href="/inscription" class="btn btn-primary px-3 d-none d-lg-flex">s'inscrire</a>
                </div>
            </nav>
        </div>
        <!-- Navbar End -->
        ...
        <div class="container-fluid header bg-white p-0">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 p-5 mt-lg-5">
                    <h1 class="display-5 animated fadeIn mb-4">acheter ou louer <span class="text-primary">votre
                            bien</span> immobilier en un clic</h1>
                ...
                <div class="row g-0 gx-5 align-items-end">
                    <div class="col-lg-6">
                        <div class="text-start mx-auto mb-5 wow slideInLeft" data-wow-delay="0.1s">
                            <h1 class="mb-3">swippez la liste de nos bien</h1>
                            <p>des studios appartement et villa de dernieres generation a vendre et a louer</p>
                        </div>
                    </div>
                    ...
                    <div id="tab-1" class="tab-pane fade show p-0 active">
                        <div class="row g-4">
                            ...
                            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                                <div class="property-item rounded overflow-hidden">
                                    <div class="position-relative overflow-hidden">
                                        <a href=""><img class="img-fluid" src="template/img/property-2.jpg"
                                                alt=""></a>
                                        <div
                                    ...
                                    <div class="p-4 pb-0">
                                        <a class="d-block h5 mb-2" href="">Nom villa</a>
                                        <p><i class="fa fa-map-marker-alt text-primary me-2"></i>adresse</p>
                                        <p>description</p>
                                        <form action="inscription" method="get" onsubmit="return showAlert()">
                            ...
                            <div class="col-12 text-center">
                                ...
                                <div class="col-12 text-center">
                                    <a class="btn btn-primary py-3 px-5" href="/inscription" onclick="Alert()">Voir plus</a>
                                    <script>
                                        function Alert() {
                                            alert("Veuillez vous connecter pour voir plus de biens.");
                                            // Ne retourne pas false pour permettre la redirection
                                        }
                                    </script>
                                </div>
                        ...
                        <div class="bg-white border rounded p-4">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ps-3">
                                    ...
                                    <a class="btn btn-primary py-3 px-5" href="/inscription">voir plus</a>
